...
export const newsItems: Article[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Le Kosovo débutera son Euro contre l’Allemagne le samedi 10 juin à 15 heures. Quatre jours plus tard, le mercredi 14 juin à 14 heures, les Dardanët défieront l’Angleterre avant de terminer la phase de groupes face à la République tchèque le lundi 19 juin à 20 heures. Les trois rencontres seront disputées sur terrain neutre dans les enceintes britanniques retenues pour la compétition.",
      "Pour achever sa préparation, le Kosovo recevra d’abord l’Écosse le lundi 29 mai à 19 h 30, puis se déplacera au pays de Galles le dimanche 4 juin à 14 h 30. Ces deux oppositions britanniques permettront au staff de préparer l’intensité, les duels et l’atmosphère particulière qui attendront l’équipe durant l’Euro organisé au Royaume-Uni.",
  ...
  },
  {
    ...
    author: "FM QuywiX",
    date: "18 septembre 2027",
    category: "Qualifications Euro 2028",
    image: "/images/kosovo-liste-septembre-octobre-2027.svg",
    body: [
      "Aurélien Quywix a retenu vingt-trois joueurs pour la fenêtre internationale la plus dense de la campagne du Kosovo. La sélection recevra la Slovénie le 28 septembre, avant deux déplacements consécutifs à Malte le 2 octobre puis au Danemark le 5 octobre.",
      "Le trio de gardiens est composé d’Arijanet Murić, Amir Saipi et Mustafë Abdullahu. Décisif face au Danemark en juin, Murić conserve naturellement son statut de numéro un au moment d’aborder trois rencontres susceptibles de redessiner le classement du groupe J.",
      "En défense, le capitaine Amir Rrahmani encadre un groupe où figurent Albian Hajdari, Mërgim Vojvoda, Leart Paçarada et Florian Hadergjonaj. Art Smakaj, désormais au LASK Linz, est également retenu et offre une solution supplémentaire dans l’axe comme devant la défense.",
  ...
  },
  {
    ...
    category: "Qualifications Euro 2028",
    image: "/images/kosovo-groupe-j-euro-2028.png",
    body: [
      "Le chemin vers l’Euro 2028 au Royaume-Uni et en Irlande est désormais tracé. Le Kosovo a été placé dans le groupe J aux côtés du Danemark, de la Slovénie, de la Lituanie et de Malte.",
      "Au classement FIFA, le Danemark occupe la 27e place et s’avance comme le grand favori de la poule. La Slovénie, 53e, précède le Kosovo, classé 69e. La Lituanie pointe au 141e rang et Malte au 161e.",
      "Aurélien Quywix assume le statut d’outsider de sa sélection : « Le Danemark est le grand favori de ce groupe et nous devons respecter son niveau. Nous ne partons pas avec le statut de favori, mais cela ne change rien à notre ambition. Nous avons montré que nous pouvions progresser vite et répondre présents dans les grands rendez-vous. »",
      "Le sélectionneur kosovar s’attend notamment à une lutte serrée avec la Slovénie : « La Slovénie possède des individualités de très haut niveau, avec Jan Oblak et Benjamin Šeško. Elle a de l’expérience et du talent, mais nous voulons être à la lutte avec elle. Chaque point comptera et nous devrons jouer avec personnalité. »",
      "Invaincu lors de sa dernière campagne de Ligue des Nations, le Kosovo peut s’appuyer sur une dynamique positive avant les huit rencontres programmées en 2027. Le premier rendez-vous aura lieu à domicile contre Malte, le 26 mars à 19 h 30."
    ]
  },
  { slug:"jeunesse-kosovo-belfast-fazliji-muqaj-2026", title:"Le Kosovo termine invaincu à Belfast", summary:"Albian Hajdari, servi par Hamza Muqaj, a offert au Kosovo un nul 1-1 en Irlande du Nord pour conclure une campagne sans défaite.", author:"FM QuywiX", date:"16 novembre 2026", category:"Ligue des Nations", image:"/images/fazliji-muqaj-irlande-du-nord-kosovo.png", body:["Déjà assuré de terminer en tête, le Kosovo voulait refermer sa campagne de Ligue des Nations sans connaître la défaite. À Windsor Park, les hommes d’Aurélien Quywix ont résisté à la pression nord-irlandaise et obtenu un match nul 1-1.","La jeunesse kosovare a marqué cette dernière soirée. À la 49e minute, Hamza Muqaj a trouvé Albian Hajdari, dont la finition a donné l’avantage aux visiteurs. Shea Charles a égalisé à la 62e minute sur un service de Jamal Lewis.","Aligné au cœur de la défense à trois, Betim Fazliji a participé à l’effort collectif face aux vingt tirs adverses. Muqaj s’est distingué dans l’entrejeu avec une passe décisive et une prestation pleine d’assurance, symbole d’une génération qui gagne progressivement sa place.","Arjanet Muriç, élu homme du match avec une note de 7,87, a préservé le point du nul grâce à plusieurs interventions importantes. Le Kosovo boucle ainsi le groupe avec 14 points, quatre victoires, deux nuls et aucune défaite." ] },
  { slug:"muriqi-valide-premiere-place-kosovo-2026", title:"Muriqi valide la première place du Kosovo", summary:"Le but de Vedat Muriqi contre la Lettonie (1-0), conjugué au faux pas nord-irlandais face à la Biélorussie, offre au Kosovo la première place du groupe.", author:"FM QuywiX", date:"13 novembre 2026", category:"Ligue des Nations", image:"/images/muriqi-premiere-place-kosovo.png", body:["Le Kosovo a assuré l'essentiel face à la Lettonie. Au Olympic Stadium Adem Jashari, le but de Vedat Muriqi à l'heure de jeu a offert une victoire 1-0 aussi courte au score que nette dans le jeu.","Servi par Leart Paçarada à la 60e minute, l'avant-centre a fait exploser le public. Le Kosovo a ensuite dominé la rencontre, avec 58 % de possession, 25 tirs et 3,45 xG, sans concéder la moindre occasion franche.","La soirée a pris une dimension encore plus forte avec le résultat de l'autre rencontre : l'Irlande du Nord s'est inclinée 2-1 face à la Biélorussie. Ce faux pas valide la première place du Kosovo dans le groupe.","Portés par le soutien de Pristina et la rage de vaincre de Muriqi, Aurélien Quywix et ses joueurs peuvent désormais savourer une qualification construite avec sérieux et ambition."] },
  { slug:"rashica-celina-forfaits-novembre-2026", title:"Rashica et Celina forfaits pour le rassemblement", summary:"Aurélien Quywix devra composer sans Milot Rashica ni Bersant Celina pour les rendez-vous de novembre.", author:"FM QuywiX", date:"5 novembre 2026", category:"Sélection nationale", image:"/images/kosovo-liste-novembre-2026.png", body:["À quelques jours du rassemblement de novembre, Aurélien Quywix a confirmé deux absences importantes dans son groupe : Milot Rashica et Bersant Celina sont forfaits.","Le sélectionneur devra donc réorganiser son animation offensive et s'appuyer sur les joueurs en forme, notamment Edon Zhegrova, Fisnik Asllani, Vedat Muriqi et les nouveaux convoqués.","En conférence de presse, Aurélien Quywix a insisté sur la force collective de sa sélection. La convocation de novembre offre aussi une opportunité à Emir Rashica et Meriton Korenica de s'affirmer dans le groupe."] },
  {
